 ...
 * @author ケネス
 */
public class JURONGCHANGI6 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            _cisTraffic = (CISTraffic) list.get(constants.CAMERA_JURONGCHANGI6);

            request.setAttribute("title", "Jurong - Changi 06");
