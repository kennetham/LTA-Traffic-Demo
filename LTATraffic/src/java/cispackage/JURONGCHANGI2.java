 ...
 * @author ケネス
 */
public class JURONGCHANGI2 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            _cisTraffic = (CISTraffic) list.get(constants.CAMERA_JURONGCHANGI2);

            request.setAttribute("title", "Jurong - Changi 02");
