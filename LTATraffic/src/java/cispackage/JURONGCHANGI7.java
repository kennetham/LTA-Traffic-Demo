 ...
 * @author ケネス
 */
public class JURONGCHANGI7 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            _cisTraffic = (CISTraffic) list.get(constants.CAMERA_JURONGCHANGI7);

            request.setAttribute("title", "Jurong - Changi 07");
