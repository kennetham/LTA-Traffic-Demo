 ...
 * @author kenneth
 */
public class KPETPEECPCC extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            _cisTraffic = (CISTraffic) list.get(constants.CAMERA_KPETPEECPCC);

            request.setAttribute("title", "KPE(TPE) - ECP(Changi) - ECP(City)");
