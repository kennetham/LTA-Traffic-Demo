 ...
 * @author ケネス
 */
public class KPEJURONGCHANGI extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            _cisTraffic = (CISTraffic) list.get(constants.CAMERA_KPEJURONGCHANGI);

            request.setAttribute("title", "KPE - Jurong - Changi");
