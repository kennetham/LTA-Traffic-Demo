 ...
 * @author ケネス
 */
public class SLEPIECHANGIJURONG extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            _cisTraffic = (CISTraffic) list.get(constants.CAMERA_SLEPIECHANGIJURONG);

            request.setAttribute("title", "SLE - PIE(Changi) - PIE(Jurong)");
