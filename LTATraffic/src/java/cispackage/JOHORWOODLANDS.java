 ...
 * @author kenneth
 */
public class JOHORWOODLANDS extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            _cisTraffic = (CISTraffic) list.get(constants.CAMERA_JOHORWOODLANDS);

            request.setAttribute("title", "Johor - Woodlands");
