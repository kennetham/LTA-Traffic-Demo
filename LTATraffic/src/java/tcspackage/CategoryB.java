...
import dataservice.TCSDataServiceQuery;
 ...
 * @author kenneth
 */
public class CategoryB extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<TCSTraffic> list = _tcsDataServiceQuery.getNearbyTrafficConditionsB();
...
//            out.println(_tcsDataServiceQuery.getTrafficConditions());
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet CategoryA</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet CategoryA at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
             */
        } finally {
